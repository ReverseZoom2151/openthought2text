...
def test_t15_discovery_requires_copy_task_layout_and_intracortical_contract(tmp_path) -> None:
    ...
    write_descriptor(
        tmp_path,
        dataset_id="t15_copy_task",
        modality="intracortical",
        task="copy_typing",
        recordings_dir="t15_copyTask_neuralData",
        split_manifest="t15_copyTaskData_description.csv",
    )
...
def test_t15_discovery_reports_missing_fixed_paths(tmp_path) -> None:
    ...
    write_descriptor(
        ...
        modality="intracortical",
        task="copy_typing",
        recordings_dir="signals",
        split_manifest="splits.csv",
    )
